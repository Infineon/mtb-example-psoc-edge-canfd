...
The following example clones the "[CAN FD](https://github.com/Infineon/mtb-example-psoc-edge-canfd)" application with the desired name "MyCANFD" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-canfd --user-app-name MyCANFD --target-dir "C:/mtb_projects"
   ```
